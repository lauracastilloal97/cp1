...
class getComentarioRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ComentarioRepository.php';

        return $container->privates['App\\Repository\\ComentarioRepository'] = new \App\Repository\ComentarioRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
