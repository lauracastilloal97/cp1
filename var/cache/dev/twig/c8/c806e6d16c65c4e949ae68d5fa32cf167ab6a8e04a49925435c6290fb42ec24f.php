...
class __TwigTemplate_32af9d25f3435198f7cfb198ba5fcd3498f65a4fd17a389b08b1a256bc6266a2 extends Template
{
    private $source;
    private $macros = [];
...
{% if pageCount > 1 %}
    <nav>
        ...
        <ul class=\"justify-content-center pagination{{ classAlign }}{{ classSize }}\">
