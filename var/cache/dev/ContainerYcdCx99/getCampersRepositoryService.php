 ...
 */
class getCampersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CampersRepository' shared autowired service.
     *
     * @return \App\Repository\CampersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CampersRepository.php';

        return $container->privates['App\\Repository\\CampersRepository'] = new \App\Repository\CampersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
