...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer8a224 && ($this->initializer8a224->__invoke($valueHolderc72f0, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer8a224) || 1) && $this->valueHolderc72f0 = $valueHolderc72f0;

        if ($this->valueHolderc72f0 === $returnValue = $this->valueHolderc72f0->paginate($target, $page, $limit, $options)) {
            return $this;
        }
