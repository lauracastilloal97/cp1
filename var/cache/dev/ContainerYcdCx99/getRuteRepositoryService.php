 ...
 */
class getRuteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RuteRepository' shared autowired service.
     *
     * @return \App\Repository\RuteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RuteRepository.php';

        return $container->privates['App\\Repository\\RuteRepository'] = new \App\Repository\RuteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
